...
file = pathscn + "pr_historical_ACCESS-CM2"+locations[0] + ".txt"
...
for loca in locations[1:-1]:
    file = pathscn + "pr_historical_ACCESS-CM2" + loca + ".txt"
...
pcpdf.to_csv(pathSwat + "pcp.pcp",index=None,header=None)